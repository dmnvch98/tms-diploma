...
public class FileController {
    ...
    public ResponseDto uploadAvatar(@Parameter(description = "Avatar image file", required = true) @RequestPart("file") final MultipartFile file,
    ...
    public List<String> getFilesList(@Parameter(description = "Storage name", required = true) @PathVariable String storageName) {
        return fileFacade.getFilesList(storageName);
    }

    @Operation(summary = "Get user avatar URL by user ID")
    @GetMapping("avatar/{userId}")
    public ResponseDto getAvatarUrl(@Parameter(description = "User ID", required = true) @PathVariable("userId") final Long userId) {
    ...
    public boolean deleteAvatar(@Parameter(description = "User ID", required = true) @PathVariable final Long userId) {
    ...
    public ResponseDto uploadDefaultAvatar(@Parameter(description = "Default avatar image file", required = true) @RequestPart("file") final MultipartFile file) throws IOException {
    ...
    public ResponseDto uploadStudentVideoPresentation(@Parameter(description = "Video presentation file", required = true) @RequestPart("file") final MultipartFile file,
                                                      @Parameter(description = "Student ID", required = true) @PathVariable("studentId") Long studentId) throws IOException {
    ...
    public ResponseDto uploadTutorVideoPresentation(@Parameter(description = "Video presentation file", required = true) @RequestPart("file") final MultipartFile file,
                                                    @Parameter(description = "Tutor ID", required = true) @PathVariable("tutorId") Long tutorId) throws IOException {
    ...
    public ResponseDto getStudentVideoPresentationUrl(@Parameter(description = "Student ID", required = true) @PathVariable("studentId") final Long studentId) {
    ...
    public ResponseDto getTutorVideoPresentationUrl(@Parameter(description = "Tutor ID", required = true) @PathVariable("tutorId") final Long tutorId) {
    ...
    public ResponseEntity<Boolean> deleteStudentVideoPresentation(@Parameter(description = "Student ID", required = true) @PathVariable final Long studentId) {
    ...
    public ResponseEntity<Boolean> deleteTutorVideoPresentation(@Parameter(description = "Tutor ID", required = true) @PathVariable final Long tutorId) {
